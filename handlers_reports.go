...
func hMeta(c *Ctx) {
	...
	jsonOK(c.W, map[string]any{
		...
		"access_status_labels":        AccessStatusLabels,
		"access_reject_labels":        AccessRejectReasonLabels,
		"access_sensitive_labels":     AccessSensitiveLabels,
		"access_outdoor_labels":       AccessOutdoorAreaLabels,
		"communities":               comms,
		"teams":                     teams,
		"users":                     users,
	})
